...
class CodeGenerator
{
    ...
    public static function generateMigration($table, $generate = false, $comm = null)
    {
        ...
        $tableP = str_singular(strtolower($table));
        ...
        $dbTableName = $tableP;
        $moduleName = ucfirst(str_singular($table));
    ...
    public static function generateConfig($module, $icon)
    {
        ...
        $tableP = str_singular(strtolower($module));
        $tableS = str_singular(strtolower($module));
        $config->dbTableName = $tableP;
        $config->fa_icon = $icon;
        $config->moduleName = ucfirst(str_singular($module));
        $config->moduleName2 = str_replace('_', ' ', ucfirst(str_singular($module)));
        $config->controllerName = ucfirst(str_singular($module)) . "Controller";
