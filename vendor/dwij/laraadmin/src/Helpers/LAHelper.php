...
class LAHelper
{
    ...
    public static function generateModuleNames($module_name, $icon)
    {
        ...
        $array['module'] = ucfirst(str_singular($module_name));
        $array['label'] = ucfirst(str_singular($module_name));
        $array['table'] = strtolower(str_singular($module_name));
     ...
     */
    public static function gen_password($chars_min = 6, $chars_max = 8, $use_upper_case = true, $include_numbers = true, $include_special_chars = true)
    {
