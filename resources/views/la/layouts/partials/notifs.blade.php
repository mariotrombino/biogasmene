						...
						<ul class="dropdown-menu">
							...
							<li class="user-header">
								...
								<p>
									...
									?>
									<small>Creato il <?php echo date("M. Y", strtotime($datec)); ?></small>
								</p>
							</li>
							<!-- Menu Body -->
							...
							<li class="user-footer">
								...
								@if(Auth::user()->type == "Socio")
									<a href="{{ url(config('laraadmin.adminRoute') . '/employees/') .'/'. Auth::user()->context_id }}" class="btn btn-default btn-flat">Profilo</a>
								@elseif(Auth::user()->type == "Terzisti")
								<a href="{{ url(config('laraadmin.adminRoute') . '/terzisti/') .'/'. Auth::user()->terzisti_id }}" class="btn btn-default btn-flat">Profilo</a>
								@elseif(Auth::user()->type == "Admin")
								<a href="{{ url(config('laraadmin.adminRoute') . '/admin/') .'/'. Auth::user()->id }}" class="btn btn-default btn-flat">Profilo</a>
								@endif
								</div>
